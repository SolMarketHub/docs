...
Prediction-market fees (2% on bet purchases) are sent to a known buyback wallet. You can:

1. Track the fee wallet on Solscan
2. Monitor $SOLMARKET buyback transactions once live execution is enabled
