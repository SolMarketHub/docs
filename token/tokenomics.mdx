...
|-----------|------------|---------|
| **Public launch (Hatch.fun Dev Mode)** | 80% | Available from day 1 through the Hatch launch pool. Fair launch — no presale, no VC allocation. |
...
| **Hatch Dev Mode fee routing** | SOL-side fees fund the bot stack; token-side fees burn automatically |
