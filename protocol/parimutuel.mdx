...
stateDiagram-v2
    ...
    Active --> Resolved_Yes: Resolution YES
    Active --> Resolved_No: Resolution NO
...
| **Resolved (Yes/No)** | The outcome has been submitted. Winners can claim. |
...
<CardGroup cols={2}>
  ...
  <Card title="Natural price discovery" icon="chart-line">
    Share prices naturally reflect the crowd's probability estimate as demand changes.
  </Card>
